...
OBJECTS += doublely_linked_list.o
OBJECTS += game.o
OBJECTS += main.o
OBJECTS += math_extra.o
OBJECTS += physics.o
OBJECTS += wall.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1511405717.46
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1511405717.46
